...
static auto decode_execute_and_validate(std::uint16_t inst_val, auto &flag, bool expected_decode_operands_status = true) -> void {

    ASSERT_FALSE(flag);

    chip8::instruction_t inst = chip8::instruction_t::decode(inst_val);
    inst.execute<ops_t>();
...
TEST_F(instruction_test, instruction_with_opcode_0) {
    // 0x0NNN
...
TEST_F(instruction_test, instruction_with_opcode_1) {
...
TEST_F(instruction_test, instruction_with_opcode_2) {
...
TEST_F(instruction_test, instruction_with_opcode_3) {
...
TEST_F(instruction_test, instruction_with_opcode_4) {
...
TEST_F(instruction_test, instruction_with_opcode_5) {
...
TEST_F(instruction_test, instruction_with_opcode_6) {
...
TEST_F(instruction_test, instruction_with_opcode_7) {
...
TEST_F(instruction_test, instruction_with_opcode_8) {
...
TEST_F(instruction_test, instruction_with_opcode_9) {
...
TEST_F(instruction_test, instruction_with_opcode_A) {
...
TEST_F(instruction_test, instruction_with_opcode_B) {
...
TEST_F(instruction_test, instruction_with_opcode_C) {
...
TEST_F(instruction_test, instruction_with_opcode_D) {
...
TEST_F(instruction_test, instruction_with_opcode_E) {
...
TEST_F(instruction_test, instruction_with_opcode_F) {
